...
%
%   INTERESTDAILISED1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   interestDailised1 = importfile('interestDailised.csv', 2, 4608);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/03/26 17:41:30

filename='Interest Rates/interestDailised.csv';
...
interestDailised1 = table(dataArray{1:end-1}, ...
    'VariableNames', {'Var1','liborDailised','primeDailised'});
